...
export default function ResumePage() {
	const techStackData: Array<techStack> = [
		{
	...
	const experinceArr: Array<experinceData> = [
		{
	...
	const educationArr:Array<educationData>=[
		{
...
function TechStackCard(prop: any) {
...
function ResumeInnerTitles(prop: any) {
