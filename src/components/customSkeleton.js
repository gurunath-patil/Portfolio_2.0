...
export function PortfolioCardSkeleton() {
	return (
		<div className='max-w-sm p-4 border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-400'>
			<div className='flex items-center justify-center h-36 mb-4 bg-gray-300 rounded dark:bg-gray-400'>
				<svg
					viewBox='0 0 16 20'
					fill='currentColor'
			...
			<div className='h-2 w-3/12 bg-gray-200 rounded-full dark:bg-gray-400'></div>
		</div>
	)
}
