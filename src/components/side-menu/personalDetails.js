	...
	return (
		<Box id='presonal-details-box'>
			...
			<div className='flex justify-center flex-wrap'>
				<button
					onClick={()=> window.location.href='https://www.github.com/gurunath-patil'}
					className='flex overflow-hidden items-center text-sm font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 bg-violet-700 text-white shadow hover:bg-black/90 h-9 px-4 py-2 max-w-52 whitespace-pre md:flex group relative w-7/12 sm:w-full justify-center gap-2 rounded-md transition-all duration-300 ease-out hover:ring-2 hover:ring-black hover:ring-offset-2'>
					<span className='absolute right-0 -mt-12 h-32 w-8 translate-x-12 rotate-12 bg-white opacity-10 transition-all duration-1000 ease-out group-hover:-translate-x-40'></span>
					<div className='flex items-center'>
						<svg className='w-4 h-4 fill-current me-3' viewBox='0 0 438.549 438.549'>
						...
						<span className='ml-1 text-white text-lg ps-3 sm:ms-0'>Developer</span>
					</div>
